...
public class EmpDao {
	public static Connection getConnection(){
		...
		try{
			 ...
			 String dbName = "crudservlet";
			 String dbUsername = "root";
			 String dbPassword = "";

			 Class.forName(dbDriver);
			 con = DriverManager.getConnection(dbURL + dbName + "?useTimezone=true&serverTimezone=UTC" ,dbUsername, dbPassword); 
			 }
			 catch(Exception e){
	...
	public static int save(Emp e){
		...
		try{
			Connection con = EmpDao.getConnection();
                        if(con != null){
                            System.out.println("TESTE CONEXAO OK!");
                        }
